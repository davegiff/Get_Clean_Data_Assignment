...
# determine which variables are means and standard deviations and discard others
...
# combine subject, activity and observation data and add variable names 
all_data <-cbind(Sub_data,Y_data,keep)
colnames(all_data) <- c("Subject","Activity",var_names[both[,1],2])

# remove brackets and hyphens from names, add hyphen back at the start and capitalise
